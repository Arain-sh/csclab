// source --> http://thefoxwp.wpengine.com/wp-includes/js/jquery/jquery.js
...
jQuery.noConflict();
// source --> http://thefoxwp.wpengine.com/wp-includes/js/jquery/jquery-migrate.min.js
...
// source --> http://thefoxwp.wpengine.com/wp-content/plugins/revslider/public/assets/js/jquery.themepunch.tools.min.js
/********************************************
...
// source --> http://thefoxwp.wpengine.com/wp-content/plugins/revslider/public/assets/js/jquery.themepunch.revolution.min.js
/**************************************************************************
...
!function(jQuery, undefined) {
    ...
    jQuery.fn.extend({
        ...
        revremoveslide: function(a) {
            return this.each(function() {
                var b = jQuery(this);
                if (b != undefined && b.length > 0 && jQuery("body").find("#" + b.attr("id")).length > 0 && opt && opt.li.length > 0 && (a > 0 || a <= opt.li.length)) {
                    var c = jQuery(opt.li[a])
                      , d = c.data("index")
                      , e = !1;
                    opt.slideamount = opt.slideamount - 1,
                    removeNavWithLiref(".tp-bullet", d, opt),
                    removeNavWithLiref(".tp-tab", d, opt),
                    removeNavWithLiref(".tp-thumb", d, opt),
                    c.hasClass("active-revslide") && (e = !0),
                    c.remove(),
                    opt.li = removeArray(opt.li, a),
                    opt.carousel && opt.carousel.slides && (opt.carousel.slides = removeArray(opt.carousel.slides, a)),
                    opt.thumbs = removeArray(opt.thumbs, a),
                    _R.updateNavIndexes && _R.updateNavIndexes(opt),
                    e && b.revnext(),
